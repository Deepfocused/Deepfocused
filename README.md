...
| 기간                      | 회사명 | 프로젝트     |
|:------------------------|:---------|:--------|
| 2023.11.20 -  | <a href="https://www.com2verse.com/" target="_blank"><img src="https://img.shields.io/badge/LG CNS-white?style=for-the-badge&logo=LG&logoColor=red"/></a> | <p>1. LG Exaone 모델(v1, v2, v3, v3.5, v4.0) 추론 최적화 및 vLLM(custom, 오픈 소스 기여), sglang(custom, 오픈 소스 기여)에 적용 및 실제 서비스에 적용</p><p>2. LG LLaVA 모델 추론 최적화 및 vLLM에 적용 및 실제 서비스에 적용</p><p>3. Google Cloud Platform Controller API 서버 개발 및 사내 서비스에 적용</p>|
